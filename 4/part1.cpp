...
int getWinningBoardID(vector<int> &draws, unordered_map<int,vector<Board*>> &boards) {
...
int main()
{
  ...
  int answer = getWinningBoardID(draws, boards);
  cout << "[Part 1] " << answer << endl;
  answer = getLosingBoardID(draws, boards);
